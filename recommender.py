...
def recommender (user, recommender, idQuestion, timestamp):
	...
	if flagUserExists == False:
		#print "if"
		recommender.append([[user, timestamp, "Q1-hard,Q2-hard,Q3-hard,Q4-hard,Q5-hard,Q6-hard,Q7-hard,Q8-hard,Q9-hard,Q10-hard"], [[False,False,False,False], [False,False,False,False],["0"], ["Q1-hard"],["0"]],[[False,False,False,False], [False,False,False,False], ["0"], ["Q2-hard"],["0"]],[[False,False,False,False], [False,False,False,False],["0"], ["Q3-hard"],["0"]],[[False,False,False,False], [False,False,False,False],["0"], ["Q4-hard"],["0"]],[[False,False,False,False], [False,False,False,False],["0"], ["Q5-hard"],["0"]],[[False,False,False,False], [False,False,False,False],["0"], ["Q6-hard"],["0"]],[[False,False,False,False], [False,False,False,False],["0"], ["Q7-hard"],["0"]],[[False,False,False,False], [False,False,False,False],["0"], ["Q8-hard"],["0"]],[[False,False,False,False], [False,False,False,False],["0"], ["Q9-hard"],["0"]],[[False,False,False,False], [False,False,False,False],["0"], ["Q10-hard"],["0"]]])
	#print "recommender 2"
	#print "BTN :" + btnTroca	
	if len(recommender) > 0:
		...
		for userActives in recommender:
			if userActives[0][0] == user:
				...
				#print "recommender 4"
				if userActives[idQuestion][4][0] == "0":
				...
				elif userActives[idQuestion][4][0] == "1":
					if userActives[idQuestion][1][0] == True:
						#recommendation = "ok"
						print "Esta Questao ja utilizou todas as adaptacoes"				
					elif timestamp - userActives[0][1] > 7000: 
...
def answerBtnQuestionEasy(user, recommender, idQuestion, timestamp):
	#print "AQUI1"
	flagUserExists = False
	#print "change 1"
	#Verificando se o usuario existe na lista do recommender
	...
	if len(recommender) > 0:
		...
		i = 0
		#print "change 4"
		#[[False,False,False,False], [False,False,False,False],["0"], ["Q1-hard"],["0"]],[[False,False,False,False], [False,False,False,False], ["0"], ["Q2-hard"],["0"]]
		for userActives in recommender:
			if userActives[0][0] == user:
				#print "AQUI4"
				...
				questions =  userActives[0][2]
				questions = questions.split(",")
				questions[idQuestion-1] = "Q"+ str(idQuestion) + "-hard"
				aux = ""
				for i in questions:
				#questions = questions[0] + "," + questions[1] + "," + questions[2]
					aux = aux+ "," + i
				questions = aux[1:]
				userActives[0][2] = questions
				userActives[idQuestion][3][0] = "Q"+ str(idQuestion) + "-hard"
				#userActives[idQuestion][3][0] = "ok"
				recommendation =  userActives[idQuestion][3][0]
				#print ""
